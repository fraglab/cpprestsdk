...
#pragma push_macro("assert") // FL[FD-000]: Enable coexists of CRY_ASSERT and generic one
...
#endif
#pragma pop_macro("assert") // FL[FD-000]: Enable coexists of CRY_ASSERT and generic one
} // utilities
} // safeint3
